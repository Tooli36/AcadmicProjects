...
public class ShowCompletedTasks extends Activity implements OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        cursor = dbHelper.chooseCompleted();
    ...
    {
        Intent intent_home = new Intent(ShowCompletedTasks.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
